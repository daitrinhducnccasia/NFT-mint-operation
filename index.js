...
const main = async() => {
    ...
    let withdrawIds = ['85c1719579c3491993c8ea4e97ce6d6b', '0418060f3f4e416ca7686acdc4e33955']

    try {
        await userAsset(asset)

        // await Promise.all(
        //     destinationAddressList.map(async (addr) => {
        ...
        logArray.forEach(
            (line) => { file.write(JSON.stringify(line) + '\n'); })
        file.end()
    }catch(e){
        console.error(e)
    }
